...
def make_full_document() -> DocumentIR:
    ...
    table = Table(
        ...
        cells=(
            _cell(
                "header-metric", 0, 0, "指标 / Metric", 1,
                BBox((40.0, 350.0, 290.0, 400.0)), page1_provenance_id,
                is_header=True,
            ),
            _cell(
                "header-value", 0, 1, "2025", 1,
                BBox((290.0, 350.0, 555.0, 400.0)), page1_provenance_id,
                is_header=True,
            ),
            merged_cell,
            _cell(
                "value-row-1", 1, 1, "120", 1,
                BBox((290.0, 410.0, 555.0, 760.0)), page1_provenance_id,
            ),
            _cell(
                "value-row-2", 2, 1, "128", 2,
                BBox((290.0, 40.0, 555.0, 150.0)), page2_provenance_id,
            ),
        ),
        caption_block_ids=(),
